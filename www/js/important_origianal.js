//var xurlq 			= "http://sicapsolucoes.com.br/contt/API/api.php";
var xurlq 			= "http://sicapsolucoes.com.br/contabilidade/API/api.php";
var idp = localStorage.getItem("idp");
var y = gbdid();
var u = xzoper();
//var imgrel = "http://sicapsolucoes.com.br/imgprefeitura/"+decode_text(localStorage.getItem("xCy&@img"))+"_2.png";
...
//var get_url_relatorio 	= "http://31.220.59.48:8080/relatorios/gerenciadorrelatorio?y="+y+"&relatorio=";
function click() {
